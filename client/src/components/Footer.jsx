            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                ...
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        ...
                        <a className="hover:text-slate-600 transition" href="#">Projects</a>
                        <a className="hover:text-slate-600 transition" href="#">Testimonials</a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        ...
                        <div className="flex items-center">
                            <input className="rounded-lg bg-gray-100 border border-slate-400 mr-3 outline-none w-full max-w-64 h-11 px-3" type="email" placeholder="Enter your email" />
                            <button className="cursor-pointer border border-black transition px-4 h-11 text-black rounded-lg hover:bg-black hover:text-white">
                                Subscribe
                            </button>
                        </div>
                    </div>
